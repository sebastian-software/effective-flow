...
Wenn no valid value is set for `applyReview.defaultCommitStrategy`: Frage den User: **Which commit strategy should be used for the findings?**
...
Wenn no valid value is set for `applyReview.stashPolicy`: Frage den User: **How should stashes left behind during the run be handled when a decision is needed?**
...
Frage den User: **How should this stash be handled?**
