...
4. Do not run any standalone project validation; linting, tests, and other quality checks are the job of other skills such as ``code-validator`` and ``test-writer``.
