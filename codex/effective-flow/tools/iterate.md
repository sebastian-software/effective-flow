...
Frage den User: **Klassifizierte Punkte freigeben und umsetzen?**
- Ja -- Freigabe erteilt, Umsetzung und Rücklieferung laufen gated weiter
...
- Anpassen -- Feedback als Freitext eingeben, z. B. einzelne Punkte abwählen
...
1. Starte `code-validator` bzw. das projektweite Qualitäts-Gate.
