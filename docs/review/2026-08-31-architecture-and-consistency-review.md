...
| §5 behavioural eval layer                                      | partial     | `364f4d0` (#399), `1d8a0ed` (#407), `4321151` (#417), and the 2026-09-14 configured-reviewer delivery cover six merge-gate scenarios at five valid runs each; `iterate` classification still has none                                                        |
| F-15 `merge-gate` size                                         | implemented | `2379fbe` (#400), `ceca964` (#401), `6127387` (#402), `cf71425` (#419), and the 2026-09-14 configured-reviewer extraction reduce the built core from 2 737 to 2 120 lines; the unsupported ~1 200 target is withdrawn and the separate `iterate` gap remains |
| F-15 prerequisite: an eval scenario with a configured reviewer | implemented | `configured-reviewer-set-aside-blocks` reaches Phase 3 in five valid current-build runs, validates two attributed `deferred` outcomes each time, repeats the Phase-4 reads, and records no merge call                                                        |
