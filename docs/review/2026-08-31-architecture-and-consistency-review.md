...
| M-3 `commit-message-rules` move candidate                      | withdrawn   | not moved: the fragment stays in Effective Flow, with `effective-delivery` declared authoritative for commit-message craft and the runtime-effect and squash-title rules named as overrides                                                                                                                                                                                                                                                  |
...
| M-5 `adr-convention` + `project-adr-convention` move candidate | withdrawn   | not moved: `adr-convention` is the declaration `effective-product` requires before a living record is used, and `project-adr-convention` is the resolution mechanism the skill leaves to the deferring side                                                                                                                                                                                                                                  |
