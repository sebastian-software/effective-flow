...
| `effective-web`            | `frontend-reviewer`, `ui-implementer`, `test-writer`, `e2e-tester`                                     | delegate (Reviewer/UI) / route (Test-Agents) | vollständig – Barrierefreiheit, Core Web Vitals, CSS-Architektur, React, Forms, i18n (versionierte Standards wie WCAG bleiben im Skill).                                                                                                                                                                                                                                                                                                                                                                                                                               |
