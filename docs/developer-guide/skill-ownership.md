...
| `codebase-improvement`     | `review`, `refactor`, `plan`, `plan-issue`, `plan-review`, `docs`, `generic-product-reviewer`                | route-when-relevant                                                        | The skill owns generic audit and plan-quality judgment, including repository-wide documentation audits and gap prioritization routed out of `docs`. Effective Flow retains routing, artifacts, finding IDs, scorecard gates, reports, and delivery.                                 |
...
- **`tech-docs` and the documentation workers:** The central skill owns documentation craft and
  ...
  boundary and target-path approval stay here.
