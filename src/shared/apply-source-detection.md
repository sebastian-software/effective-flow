...
`{{SKILL:apply-review}}` — the flow:

| Source type       | Responsible skill        | Target / note                                    |
| ----------------- | ------------------------ | ------------------------------------------------ |
| `plan`            | `{{SKILL:apply-plan}}`   | –                                                |
| `review-report`   | `{{SKILL:apply-review}}` | `local` target, report flow                      |
| `review-epic`     | `{{SKILL:apply-review}}` | tracker target of the reference, epic mode       |
| `review-finding`  | `{{SKILL:apply-review}}` | tracker target of the reference, issue-list mode |
