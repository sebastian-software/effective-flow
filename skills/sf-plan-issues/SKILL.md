...
Schreibe das Planungsergebnis als Issue-Kommentar (Operation „Kommentar hinzufügen" aus dem Mapping). Beginne jeden Plugin-Kommentar mit der Markierung `<!-- sf-plan-issues -->`. Kanonische Struktur des Kommentars:
