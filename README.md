...
- **Technical:** [docs/developer-guide/README.md](https://github.com/sebastian-software/effective-flow/blob/develop/docs/developer-guide/README.md) –
  source-to-dist build, router concept, contributing to the project.

<!-- effective-flow:delivery-footer -->

---

_This is the machine-managed delivery branch. Source, developer documentation, and contributions live on [`develop`](https://github.com/sebastian-software/effective-flow/tree/develop)._
