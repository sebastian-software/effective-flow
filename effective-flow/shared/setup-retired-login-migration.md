...
effective-flow setup applies this writer-only contract when repairing a retired
...
retired sources, and rerun effective-flow setup. Leave every source row unchanged until either that manual
