...
`effective-flow merge-gate`'s always-loaded core – the conflict branch itself, the modes of
...
that creates it. `effective-flow merge-gate` is this fragment's only consumer.
