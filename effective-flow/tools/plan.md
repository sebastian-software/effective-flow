...
**Load on demand:** Read `shared/runtime-state-safety.md`, when a legacy runtime directory migration is about to mutate `.effective-flow/`, or a hidden-mode plan write targets a path below `.effective-flow/`.
