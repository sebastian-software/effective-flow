...
Runs a specialized Rust review: memory safety, unsafe, error handling, Clippy idiomatics, concurrency, API design, security, and design-decision-aware findings.
