...
Thin test adapter: routes browser test depth to effective-web, focused non-frontend test design to effective-engineering, and existing-check execution to effective-delivery.
