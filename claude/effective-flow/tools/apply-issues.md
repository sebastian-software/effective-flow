...
- multiSelect: false
- options:
  - label: "Yes", description: "Approval granted, the workflow continues gated (status update per issue)"
  - label: "Autonomous via /goal", description: "Remaining phases autonomous under native /goal — the skill outputs the /goal string to paste"
  - label: "Adjust", description: "Enter feedback as free text (e.g. correct the issue selection or target skill)"
