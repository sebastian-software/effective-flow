...
- multiSelect: false
- options:
  - label: "Ja", description: "Freigabe erteilt, Workflow läuft gated weiter (Statusmeldung pro Issue)"
  ...
  - label: "Anpassen", description: "Feedback als Freitext eingeben (z. B. Issue-Auswahl oder Ziel-Skill korrigieren)"
