...
- Root-`README.md` als Marketing-Einstieg der Standard-Doku-Struktur: ``effective-flow-marketing-writer``
- User- und Projekt-Dokumentation (inkl. Benutzerdoku unter `docs/user-guide/` und technischer Doku unter `docs/developer-guide/`): ``effective-flow-docs-writer``
- In-Code-Dokumentation, JSDoc/TSDoc, CLI-Help-Texte: ``effective-flow-code-documenter``
- Technische Prüfung bei generierten Artefakten, CLI-Help, Build-Dateien oder Code-Dateien: ``effective-flow-code-validator``
...
- wenn der Ziel-Pfad auf eine bestehende Datei zeigt: kläre mit dem User Ersatz oder neuen Slug, bevor ``effective-flow-docs-writer`` startet
...
3. Bestimme die Doku-Kategorie gemäß `Doku-Kategorien`:
   ...
   - beim Marketing-Einstieg (Root-`README.md`) entfällt die Kategorie: sie ist keine der vier `docs/`-Kategorien, der Ziel-Pfad ist `README.md` und die Umsetzung geht an ``effective-flow-marketing-writer``
...
2. Starte den passenden Agent:
   - ``effective-flow-marketing-writer`` für die Root-`README.md` als Marketing-Einstieg
   - ``effective-flow-docs-writer`` für Kategorie-Guides, Kategorie-Einstiegs-READMEs (z. B. `docs/user-guide/README.md`, `docs/developer-guide/README.md`), API-/CLI-Doku, Migration, Changelog und Skill-Dokumentation – **nicht** für die Root-Marketing-README
   - ``effective-flow-code-documenter`` für JSDoc/TSDoc, Inline-Kommentare und CLI-Help-Texte in Code-Dateien
...
4. Starte ``effective-flow-code-validator``, wenn Doku-Änderungen technische Artefakte betreffen oder der Projekt-Build die Änderung plausibel prüfen kann.
